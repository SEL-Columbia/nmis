...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LGARecord.source'
        db.add_column('nga_districts_lgarecord', 'source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LGARecord.source'
        db.delete_column('nga_districts_lgarecord', 'source')
