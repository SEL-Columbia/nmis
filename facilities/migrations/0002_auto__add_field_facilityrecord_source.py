...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityRecord.source'
        db.add_column('facilities_facilityrecord', 'source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityRecord.source'
        db.delete_column('facilities_facilityrecord', 'source')
