...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KeyRename.old_key'
        db.alter_column('facilities_keyrename', 'old_key', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'KeyRename.new_key'
        db.alter_column('facilities_keyrename', 'new_key', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'KeyRename.data_source'
        db.alter_column('facilities_keyrename', 'data_source', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'KeyRename.old_key'
        db.alter_column('facilities_keyrename', 'old_key', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'KeyRename.new_key'
        db.alter_column('facilities_keyrename', 'new_key', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'KeyRename.data_source'
        db.alter_column('facilities_keyrename', 'data_source', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        'facilities.keyrename': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'old_key': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
