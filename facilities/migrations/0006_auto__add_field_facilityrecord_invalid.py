...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityRecord.invalid'
        db.add_column('facilities_facilityrecord', 'invalid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityRecord.invalid'
        db.delete_column('facilities_facilityrecord', 'invalid')
